...
HD_PWD='F:/jpeg_encoder/asic/float_mul_nb/float_mul_nb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log float_mul_nb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source float_mul_nb.tcl -notrace
