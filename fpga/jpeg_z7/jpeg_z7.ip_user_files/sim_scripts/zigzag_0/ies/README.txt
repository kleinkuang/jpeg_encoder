...
#
# Generated by export_simulation on Tue Oct 27 18:30:53 +0000 2020
#
################################################################################
...
'-reset_run' switch to the './zigzag_0.sh' script.

./zigzag_0.sh -reset_run
...
./zigzag_0.sh -noclean_files

For more information on the script, please type './zigzag_0.sh -help'.
