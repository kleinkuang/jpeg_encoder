...
HD_PWD='F:/jpeg_encoder/asic/float_mul_nb/float_mul_nb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_mul_nb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_mul_nb.tcl
