...
#
# Generated by export_simulation on Tue Oct 27 17:01:01 +0000 2020
#
################################################################################
...
'-reset_run' switch to the './int8_to_float.sh' script.

./int8_to_float.sh -reset_run
...
./int8_to_float.sh -noclean_files

For more information on the script, please type './int8_to_float.sh -help'.
