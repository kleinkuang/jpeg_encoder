...
#
# Generated by export_simulation on Fri Nov 20 11:36:16 +0000 2020
#
################################################################################
...
'-reset_run' switch to the './float_to_int8_gold.sh' script.

./float_to_int8_gold.sh -reset_run
...
./float_to_int8_gold.sh -noclean_files

For more information on the script, please type './float_to_int8_gold.sh -help'.
